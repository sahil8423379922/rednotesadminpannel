...
class AvlQuestion extends StatefulWidget {
  final String setname;
  final String examname;
  const AvlQuestion({super.key, required this.setname, required this.examname});

  @override
  State<AvlQuestion> createState() => _AvailableSubjectState();
}

class _AvailableSubjectState extends State<AvlQuestion> {
  List<String> sub = [];
  List<String> subkey = [];
